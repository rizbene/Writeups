...
riz@kali:~/Documents/THM/ReversingELF$ strings crackme2
/lib/ld-linux.so.2
libc.so.6
_IO_stdin_used
puts
...
│           0x0040075e      c9             leave
└           0x0040075f      c3             ret
[0x7ff7ca966360]> pdf @sym.compare_pwd
...
│       └─> 0x00400714      c9             leave
└           0x00400715      c3             ret
[0x7ff7ca966360]> db 0x004006d2
[0x7ff7ca966360]> dc
Usage : ./crackme4 password
This time the string is hidden and we used strcmp
(4084) Process exited with status=0x0
[0x7ff7ca820995]> ood 'argument'
(4084) Process terminated with status 0

==> Process finished

File dbg:///home/riz/Documents/THM/ReversingELF/crackme4 'argument' reopened in read-write mode
[0x7f6f70ecc360]> dc
...
```
riz@kali:~/Documents/THM/ReversingELF$ r2 -d crackme5
[0x7fcc1ca7c360]> aaa
[x] Analyze all flags starting with sym. and entry0 (aa)
[x] Analyze function calls (aac)
[x] Analyze len bytes of instructions for references (aar)
...
│           0x00400759      c9             leave
└           0x0040075a      c3             ret
[0x7f2f3c423360]> pdf @sym.compare_pwd
...
│      └──> 0x0040070f      c9             leave
└           0x00400710      c3             ret
[0x7f2f3c423360]> pdf @sym.my_secure_test
...
```
riz@kali:~/Documents/THM/ReversingELF$ ./crackme6 1337_pwd
password OK
```
...
```
riz@kali:~/Documents/THM/ReversingELF$ python3
...
```
riz@kali:~/Documents/THM/ReversingELF$ ./crackme7
Menu:
